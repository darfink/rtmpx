use crate::amf0::Amf0SerializationError;
use thiserror::Error;

use std::io;

use crate::amf3::Amf3SerializationError as Amf3Error;
...
pub enum MessageSerializationError {
    ...
    /// The values provided could not be serialized into valid AMF3 encoded data
    #[error("The values provided could not be serialized into valid AMF3 encoded data")]
    Amf3SerializationError(#[from] Amf3Error),
